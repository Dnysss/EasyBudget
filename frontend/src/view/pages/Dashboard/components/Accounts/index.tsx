...
export function Accounts() {
  ...
  if (isLoading) {
    return (
      <div className="bg-[#FC9705] rounded-2xl w-full h-full px-4 py-8 lg:p-10 flex flex-col">
  ...
  return (
    <div className="bg-amber-600 rounded-2xl w-full h-full px-4 py-8 lg:p-10 flex flex-col">
      <div>
